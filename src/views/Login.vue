          ...
          <div class="text-center mt-6">
            <p class="text-sm text-slate-600 dark:text-slate-400">
              ...
              <button 
                type="button"
                @click="activeTab = 'register'" 
                class="text-primary hover:text-cyan-300 font-bold transition-colors ml-1"
              >
                {{ t('auth.registerTab') }}
              </button>
            </p>
...
import GoogleLoading from '@/components/common/GoogleLoading.vue'
